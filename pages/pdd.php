<?
require "./vendor/connectpdd.php";
require_once "./vendor/addPostpdd.php";
require_once "./vendor/iniection.php";

$allArticle = "SELECT * FROM pdd_posts";
    ...
    <div class="wrapper">
        ...
        <div class="news-count">
            ...
            <? foreach ($mass as $elem) { ?>
                <a style="text-decoration: none;" href="../articles/statpdd.php?id=<?= $elem['id'] ?>">
