<?
require "./vendor/connectgibdd.php";
require_once "./vendor/addPostgibdd.php";
require_once "./vendor/iniection.php";

$allArticle = "SELECT * FROM gibdd_posts";
...
<head>
    ...
    <link rel="stylesheet" href="../css/gibdd.css">
    ...
    <div class="wrapper">
        ...
        <div class="news-count">
            ...
            <? foreach ($mass as $elem) { ?>
                <a style="text-decoration: none;" href="../articles/statgibdd.php?id=<?= $elem['id'] ?>">
