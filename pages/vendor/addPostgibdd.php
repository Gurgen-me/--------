<?
$link = mysqli_connect("localhost", "root", "", "gibdd");
...
if (!empty($_POST) && !empty($_FILES)) {
    ...
    $add = mysqli_query($link, "INSERT INTO gibdd_posts(post_name, post_disc, image, date) VALUES ('$post_title','$post_text', '$blob_image', '$date')");
